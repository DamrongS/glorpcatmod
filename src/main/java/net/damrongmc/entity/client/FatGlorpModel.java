...
public class FatGlorpModel<T extends GlorpEntity> extends GlorpModel<T>  {
    ...
    public FatGlorpModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition LeftArm = Body2.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(8, 30).addBox(1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(3.0F, -0.8333F, -0.1667F));

        PartDefinition RightArm = Body2.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 30).addBox(-3.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-3.0F, -0.8333F, -0.1667F));
        ...
        PartDefinition Belly = Body2.addOrReplaceChild("Belly", CubeListBuilder.create().texOffs(24, 0).addBox(-2.0F, -8.8333F, -2.1667F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(-1, 22).addBox(-3.0F, -7.8333F, -3.1667F, 6.0F, 2.0F, 6.0F, new CubeDeformation(0.0F))
                .texOffs(-2, -1).addBox(-4.0F, -5.8333F, -4.1667F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 6.0F, 0.0F));
    ...
    public void setupAnim(GlorpEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(FatGlorpAnimations.WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, FatGlorpAnimations.IDLE, ageInTicks, 1f);
        this.animate(entity.sitAnimationState, FatGlorpAnimations.SIT, ageInTicks, 1f);
    }
